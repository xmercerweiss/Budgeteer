...
as they are hard-coded into the program's source. I recommend you download the JAR to `~/Budgeteer`, then add the
function in `dist/alias.sh` to your `.bash_aliases` file.
